...
<head>
    ...
    <div class="container-fluid">
       <div class="row justify-content-center">
        <div class="col-md-4"><!--Awal col 4-->
            <div class="card" >
                <div class="card-body">
                    <h2 class="text-center">Selfiana Profil's</h2></br>
                        <p class="text-justify">Nama : Selfiana Lestari </br>
                                                Kelas   : TIF RP 18CNSA </br>
                                                NPM  : 18111093</br>
                                                Matkul  : Pemrograman WEB I </br>
                                                Dosen : Ibu Nova Agustina, ST., M.Kom.
                        </p>
                    <img src="img/mypic.jpg" height="200px"  class="rounded-circle" 
