...
<head>
    ...
    <title>Biodata V Kim Tae Hyung</title>
  ...
  <body>
        ...
        <div class="col-md-12"><br>
            <h5 class="text-center">BIODATA KIM TAE HYUNG</h5><br>
        </div>
        </div> 
        <!-- End Baris Ke 1 -->
        ...
        <div class="col-md-8"><br>
                ...
                Nama Panggung       : V (mphi)
                Nama Panggilan      : Tae Tae, Blank Tae 
                ...
                Berat Badan         : 62 Kg 
                Golongan Darah      : AB
                Warna Favorit       : Hitam, Putih, dan Hijau
                Makanan Favorit     : Japchae, Semua Jenis Daging
                Hobby               : Bersepeda dan Bermain Basket 
                Grup                : Bangtan Boys (BTS) 
                Posisi Di BTS       : Vocal, Dancer 
        ...
        <div class="col-md-3"><br>
            <img src="img/v 7.jpg" height="400px"  class="mx-auto d-block " ></br>
        </div>
