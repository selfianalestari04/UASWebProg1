...
<head>
    ...
    <span class="navbar-toggler-icon"></span>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <a class="nav-link js-scroll-trigger" href="formregister.php">SIGN UP<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
        ...
        <form name="formsRegister" action="daftar.php" method="post" onsubmit="return validateForm()">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="tempatlahir" class="form-control" placeholder="Masukkan Tempat Lahir Anda" id="TempatLahir">
                </div>
                </div>
            ...
            <div class="from-group">
                ...
                <input type="text" name="alamat" class="form-control" placeholder="Masukkan Alamat Lengkap Anda" id="AlamatLengkap">
            </div>
            
            <!-- Untuk Memisahkan Masing - Masing Form Dan Membuat Label Untuk Masing - Masing Form -->
            <div class="from-group">
                <label for="Hp">No HP</label>
                <input type="number" name="nohp" class="form-control" placeholder="Masukkan No HP Anda" id="NoHP"> 
            </div>
            ...
            <div class="row">
                ...
                <input type="email" name="e-mail" class="form-control" placeholder="Masukkan E-mail Anda" id="Email">
                </div>
                </div>
                ...
                <input type="password" name="password" class="form-control" placeholder="Masukkan Password Anda" id="Password"> </br>
                </div>
                </div>  
            </div>
